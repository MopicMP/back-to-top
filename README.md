...
[![npm version](https://badge.fury.io/js/back-to-top.svg)](https://www.npmjs.com/package/back-to-top)
...
```javascript
const { top } = require('back-to-top');

// Basic usage
const result = top('your input here');
console.log(result);
```
...
```javascript
const { top, batch } = require('back-to-top');

// Single item
const result = top('hello');
